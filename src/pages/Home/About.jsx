...
function AboutContainerElement(){
    return(
     ...
     <Heading/>
     <AboutContainerItems Image={AboutImage} TextSection="Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt eius minima, tempore ipsam alias eligendi laborum totam, praesentium quidem molestiae esse deserunt fugit expedita natus veritatis necessitatibus fugiat ipsum velit.
