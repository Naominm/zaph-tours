 ...
 function TestimonialSection(){
    return(
        <div className="testimonial-section-container">
            ...
            <CardsContent User={FirstReview} name="Will Smith" Description="Zaph Tours made our honeymoon unforgettable! Every detail was perfectly arranged."/>
        
            <CardsContent User={SecondReview} name="Kai James" Description="Zaph Tours made our honeymoon unforgettable! Every detail was perfectly arranged."/>
            <CardsContent User={ThirdReview} name="Jack Smith" Description="Incredible safari experience! We saw the Big Five up close, and the guides were amazing."/>
        </div>
        </div>
    )
 }
